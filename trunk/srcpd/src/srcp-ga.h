...
struct _GASTATE
{
  ...
  sessionid_t locked_by;     /* wer h�t den Lock? */
...
int queueGA(bus_t busnumber, int addr, int port, int action, long int activetime);
...
int lockGA(bus_t busnumber, int addr, long int duration, sessionid_t sessionid);
