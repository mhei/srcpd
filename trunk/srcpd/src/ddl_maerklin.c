...
int comp_maerklin_1(int busnumber, int address, int direction, int speed, int func) {
   ...
   DBG(busnumber, DBG_DEBUG,"command for Märklin protocol type 1: %d received", address);
...
#ifdef _DEBUG_
   printf("\ncommand for Märklin protocol type 2 (M2) received\n");
#endif
...
#ifdef _DEBUG_
   printf("\ncommand for Märklin protocol type 3 (28 speed steps) (M3) received\n");
#endif
...
#ifdef _DEBUG_
   printf("\ncommand for Märklin protocol type 4 (M4, Uhlenbrock Intellibox) received\n");
#endif
...
int comp_maerklin_5(int busnumber, int address, int direction, int speed, int func, 
   ...
   struct _GLSTATE loco;
#ifdef _DEBUG_
   printf("\ncommand for Märklin protocol type 5 (M5) received\n");
...
#ifdef _DEBUG_
   printf("\ncommand for func decoder (Märklin) (MF) received\n");
#endif
