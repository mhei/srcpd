...
int cacheInitGL(bus_t busnumber, int addr, const char protocol, int protoversion, int n_fs, int n_func);
int cacheTermGL(bus_t busnumber, int addr);

int cacheLockGL(bus_t busnumber, int addr, long int duration, sessionid_t sessionid);
